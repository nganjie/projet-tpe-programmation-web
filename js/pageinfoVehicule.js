    ...
    .then((data1)=>{
     ...
     var  pageinfo = pageinfoVehicule(data1.typeV,data1)
       ...
       button_command.addEventListener("click",()=>{
        if(getCookie("nom"))
        {
            alert("votre commande à été notifier au vendeur, il vous contactera d'ici peut. vous disposer ausssi de ses contacts pour faire le prémier pas");
        }else alert(" veillez vous indentifié avant de passer une commande");
