    ...
    constructor(tab_json) {
        tab_json.map((value) => {
            if (value.typeV == "voiture")
                this.tab_object.push(new Voiture(value.idVehicule,
            ...
            if (value.typeV == "moto")
                this.tab_object.push(new Moto(value.idVehicule,
                    value.nb_place,
                    value.typeV,
                    value.image,
                    value.prix,
                    ...
                    value.nb_roue));
            if (value.typeV == "velo")
                this.tab_object.push(new Velo(value.idVehicule,
                    value.nb_place,
                    value.typeV,
                    value.image,
                    value.prix,
